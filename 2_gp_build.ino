...
void build() {
  ...
  GP.TITLE("Autobell 🔔");
  GP.NAV_TABS_LINKS("/,/settings,/belltime,/config", "Главная,Настройки звонков,Время звонков,Конфигурация", UI_COLOR);
  ...
  GP.BOX_BEGIN();
    ...
    GP.BLOCK_BEGIN(GP_TAB, "50%", "Выбор режима для дня недели", UI_COLOR);
    ...
    GP.BLOCK_BEGIN(GP_TAB, "50%", "Даты с опред. режимом звонка", UI_COLOR); 
    ...
    GP.BLOCK_BEGIN(GP_TAB, "30%", "Длительность звонка", UI_COLOR); 
