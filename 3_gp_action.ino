...
void action() {
  ...
  if (ui.click()) {
    ...
    // Иначе - сохранение из поля ввода в переменную
    // https://github.com/GyverLibs/GyverPortal/wiki/%D0%9E%D0%B1%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%BA%D0%B0-%D0%BA%D0%BB%D0%B8%D0%BA%D0%BE%D0%B2
